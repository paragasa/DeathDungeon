...
namespace DeathDungeon.Models
{
    ...
    public class Item : Entity<Item>
    {
        ...
        public Item()
        {
            ...
            Attribute = AttributeEnum.undefined;

        }

        public Item(string name, string description, string imageuri, string guid, int range, int value, Location location, AttributeEnum attribute)
        {
            Name = name;
